...
function PresentParticipleOrPastParticipleAfterBeInner() {
...
export default function PresentParticipleOrPastParticipleAfterBe(props) {
  return (
    <Suspense fallback={null}>
      <PresentParticipleOrPastParticipleAfterBeInner {...props} />
    </Suspense>
  );
}
