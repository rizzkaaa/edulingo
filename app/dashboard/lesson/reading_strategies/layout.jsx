      ...
      <section>
        <main>
          <h4 className={styles.indicator}>
            BERANDA › MATERI › READING STRATEGIES ›{" "}
    ...
    try {
      ...
      if (userDocSnap.exists()) {
        ...
        if (currentStatusList.length > 0) {
          currentStatusList[4] = { ...currentStatusList[4], status: "done" };

          if (currentStatusList[5] && currentStatusList[5].status === "locked") {
            currentStatusList[5] = { ...currentStatusList[5], status: "progress" };
          }
