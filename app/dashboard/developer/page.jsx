    ...
    <div className={styles.container}>
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          <h2>MEET THE TEAM</h2>
          <p>
            The dedicated squad building the future of English learning. We're a
            mix of linguists, engineers, and designers obsessed with academic
            mastery.
          </p>
        </div>
      ...
      <div className={styles.teamGrid}>
        {developers.map((dev, index) => (
          <div key={index} className={styles.teamCard}>
            ...
            <p className={styles.quote}>"{dev.quote}"</p>
      ...
      <section className={styles.bottomBanner}>
        <h2>BUILT FOR MODERN ENGLISH LEARNERS</h2>
        <p>
          Join the movement of students reclaiming their learning journey with
          structured urgency and raw clarity.
        </p>
