          ...
          <div className={styles.materiCard}>
            <div className={`${styles.materiCardHeader} ${styles.orange}`}>
              ...
              <div className={styles.badges}>
                ...
                <span className={styles.badge}>~25 Soal</span>
              </div>
            </div>

            <div className={styles.materiBody}>
              <div className={styles.materiItem}>🔲 Structure Part 1</div>
              <div className={styles.materiItem}>🔲 Structure Part 2</div>
              <div className={styles.materiItem}>🔲 Written Expression Part 1</div>
              <div className={styles.materiItem}>🔲 Written Expression Part 2</div>
            </div>
          </div>

          <div className={`${styles.totalBar} ${styles.orange}`}>
